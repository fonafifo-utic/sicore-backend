...
{
    public class ExportacionReporteDeCotizaciones
    {
        ...
        public iRutaDeDescargaDelPDF ExportaCotizacionesEnPDF(IEnumerable<iReporteListadoCotizacionesMensual> datosDelReporte, string rutaImagenEncabezado, string rutaDeDescarga, string nombreArchivo)
        {
            ...
            string tituloReporte = "Reporte de Cotizaciones";
                    ...
                    foreach (var usuarioAgrupador in listaUsuarios)
                    {
                        ...
                        foreach (var dato in datosDelReporte)
                        {
                            if ((usuarioAgrupador == dato.usuario) && (sector == dato.sectorComercial))
                            {
                                ...
                                _margenIzquierda += 262;
                                _dibujaProyecto(gfx, dato.proyecto);
                                ...
                                _margenIzquierda += 29;
                                _dibujaMonto(gfx, dato.montoTotalDolares);
        ...
        private List<iColumnas> _construyeLasColumnasDelReporte()
        {
            ...
            columnas.Add(new iColumnas { nombreColumna = "Proyecto" });
        ...
        {
            if(columna.nombreColumna != "Sector")
            {
        ...
        {
            var celdaColumnaReporte = new XRect(_margenIzquierda, _margenTop - 10, 263, 15);
            gfx.DrawRectangle(_xpen(), XBrushes.White, celdaColumnaReporte);
            gfx.DrawString(nombreCliente, _fuentePequennaRegular(), XBrushes.Black,
                new XRect(celdaColumnaReporte.X + 5, celdaColumnaReporte.Y + 5, celdaColumnaReporte.Width - 5, 34), _formato());
        }

        private void _dibujaProyecto(XGraphics gfx, string proyecto)
        {
            var celdaColumnaReporte = new XRect(_margenIzquierda, _margenTop - 10, 50, 15);
            gfx.DrawRectangle(_xpen(), XBrushes.White, celdaColumnaReporte);
            gfx.DrawString(proyecto, _fuentePequennaRegular(), XBrushes.Black,
                new XRect(celdaColumnaReporte.X + 5, celdaColumnaReporte.Y + 5, celdaColumnaReporte.Width - 5, 34), _formato());
        }
