...
{
    public class iRutaDeDescargaPDF
    {
    ...
    public class iColumnasDelInforme
    {
        public string nombreColumna { get; set; }
    }

    public class DatosSolicitudPagoInforme
    {
        ...
        public iRutaDeDescargaPDF ExportaInforme(iDatosSolicitudPago datosDelReporte, string rutaImagenEncabezado, string rutaDeDescarga, string nombreArchivo)
        {
            var rutaParaDescargarElReporte = new iRutaDeDescargaPDF();
            
            var columnas = _construyeLasColumnasDelReporteCertificados();

            string tituloReporte = "SOLICITUD DE PAGO POR SERVICIOS ECOLOGICO";
            ...
            try
            {
                ...
                {
                    rutaParaDescargarElReporte = new iRutaDeDescargaPDF()
                    {
